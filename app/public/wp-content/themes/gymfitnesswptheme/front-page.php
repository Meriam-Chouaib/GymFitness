...
<?php while(have_posts()): the_post();?>
    ...
    <section class="welcome text-center section">
        <h2 class="text-primary"><?php the_field('welcome_text'); ?></h2>
    ...
    <section class="instructors">
        <div class="container section">
            ...
            <p class="text-center">Professional instructors that will help you to achieve your goals</p>
        <?php 
            gymfitness_instructors_list();
        ?>
