...
function gymfitness_scripts(){
    ...
    //Google fonts
    wp_enqueue_style( 'googlefont', 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700;800&family=Raleway:wght@400;700;900&family=Staatliches&display=swap',array(),'1.0.0');
...
/***Display hero image on background of the front-page (index) */
