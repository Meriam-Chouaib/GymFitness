...
function gymfitness_classes_list( $number = -1 ){ ?>
    <ul class="classes-list">
        ...
        ?>
        <li class="gym-class card gardient">
            ...
            <div class="card-content">
                ...
                <p><?php echo the_field('class_days'). " - " . $start_time . "  " . $end_time ; ?></p>
            </div>
...
?>
    <ul class="instructor-list">
                ...
                ?>
                        <li class="instructor">
                            <?php the_post_thumbnail('mediumSize'); ?>
                            <div class="content-text-center content">
                                <h3> <?php the_title(); ?> </h3>
                                <?php the_content();?>
                            </div>
                            <div class="specialty">
                                <?php 
                                    $specialty = get_field('speciality');
